...
/***/ function(module, exports, __webpack_require__) {
	...
	var vm = new _vue2.default({
	  ...
	  computed: {
	    ...
	    isAll: {
	      get: function get() {
	        // 这个checkbox的状态也就是他的布尔状态是根据剩余active的数量决定，如果全部完成就是全部打钩，那么这个按钮就true高亮选中
	        return this.remain === 0;
	      },
	      set: function set(boolean) {
	        // 把checkbox表单的值，也就是选中与否的布尔值传入，然后把这个布尔值传给todos每个元素的状态上
	        return this.todos.forEach(function (todo) {
	          return todo.completed = boolean;
	        });
	      }
	    },
	  ...
	  methods: {
	    ...
	    editDone: function editDone(todo, index) {
	      // 编辑完毕,复原
	    ...
	    editCancle: function editCancle(todo) {
	  ...
	  created: function created() {
	    ...
	    window.onbeforeunload = function () {
	      var dataString = JSON.stringify(_this.todos);
